// Antonio Eduardo e Joel Vinicius - Academia Maromba
...
public class Maromba {
    ...
    public static Aluno aluno1 = new Aluno("Eduardo");
    public static Aluno aluno2 = new Aluno("Joel");
    public static Aluno alunoAuxiliar = new Aluno();

    public static Colaborador colaborador1 = new Colaborador("Mateus Gomes");
    public static Colaborador colaborador2 = new Colaborador("Italo");
